...
.DESCRIPTION
    ...
    It supports NodeJS, Vanilla JavaScript, TypeScript, Python, Ruby, C#, Java, WASM, Go, C, C++, Rust, D, Cobol and more.
.PARAMETER Version
    Default: latest
...
function Install-MetaCall-AdditionalPackages {
    ...
    # Ensure the path is quoted for spaces and use the correct quoting style for Invoke-Expression
